...
using MehmetBank.Models;

namespace MehmetBank.Controllers.API
{
    ...
    {
        Mehmetbank_DbEntities db = new Mehmetbank_DbEntities();
            ...
            if (merchantCount != 0)
            {
                ...
                if (cardControl != 0)
                {
                    ...
                    if (Convert.ToInt32(mh.Cvv) == Convert.ToInt32(CVV))
                    {
                        ...
                        {
                            if (Convert.ToInt32(mh.SonKullanmaYıl) == Convert.ToInt32(ExpY))
                            {
                                if (mh.Bakiye >= Price)
                                {
                                    try
            ...
            if (merchantCount != 0)
            {
                ...
                if (cardControl != 0)
                {
                    ...
                    if (Convert.ToInt32(mh.Cvv) == Convert.ToInt32(model.CVV))
                    {
                        ...
                        {
                            if (Convert.ToInt32(mh.SonKullanmaYıl) == Convert.ToInt32(model.ExpY))
                            {
